...
// --- Shortened for readability below ---

// The rest of the components (SidebarTrigger, SidebarRail, SidebarInset, SidebarMenuButton, etc.)
// remain exactly the same as your original code, but **remove all type definitions**
// such as `<HTMLDivElement, Props>` or `VariantProps<typeof something>`.
...
// Repeat this pattern for all other `Sidebar*` components by removing type generics.

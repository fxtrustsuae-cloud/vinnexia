...
function TimeToMasterTradingSkill() {

    const verificationProgress = 20;

    const data = [
        "1-6 months, some learning is required",
        "< 1 month, I feel confident",
        "6+ months with proper studying"
    ]
    ...
    return (
        ...
        >
            ...
            >How long would you need to master trading skills?</Typography>
...
export default TimeToMasterTradingSkill;
...
// import { AnalyticsReportHeaderColumn } from './AnalyticsReportHeaderColumn';
// import { CommissionReportHeaderColumn } from './CommissionReportHeaderColumn';
// import { TradeReportHeaderColumn } from './TradeReportHeaderColumn';
import { LiveAccountHeaderColumn } from './LiveAccountHeaderColumn';
...
function LiveAccount() {
    ...
    const columns = useMemo(() => LiveAccountHeaderColumn, []);
    ...
    return (
        <Container>
            <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Live Account Report</Typography>
            <Box sx={{
                display: 'flex',

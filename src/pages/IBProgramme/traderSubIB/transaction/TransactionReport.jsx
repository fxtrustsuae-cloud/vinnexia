...
import { TransactionReportHeaderColumn } from './TransactionReportHeaderColumn';
...
function TransactionReport() {
  ...
  const columns = useMemo(() => TransactionReportHeaderColumn, []);
  ...
  return (
    <Container>
      <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Transaction Report</Typography>
      <Box sx={{
        display: 'flex',

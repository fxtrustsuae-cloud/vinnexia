...
// import { IBSummaryHeaderColumn } from './IBSummaryHeaderColumn';
import TotalCommissionAndLots from '../TotalCommissionAndLots';
import { IBStatisticsBHeaderColumn } from './IBStatisticsBHeaderColumn';
...
function IBStatistics() {
    ...
    const columns = useMemo(() => IBStatisticsBHeaderColumn, []);
    ...
    return (
        <Container>
            <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>IB Statistics</Typography>
            <TotalCommissionAndLots />
            {/* <Box sx={{
                display: 'flex',
            ...
            <Box sx={{
                ...
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 2 }}>
                    ...
                    <Stack>
                        <InputLabel sx={{ mb: 0.5, fontSize: 12 }}>Name</InputLabel>
                        <Selector

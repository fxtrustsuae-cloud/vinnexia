...
export const TeamWithdrawReportHeaderColumn = [
    ...
    columnHelper.accessor('mt5Login', {
        ...
        // size: 100,
        Cell: ({ row }) => {
            const mt5Login = row.original.mt5Login;
            return (
                mt5Login ?
                    <Typography>{mt5Login}</Typography>
                    :
    ...
    columnHelper.accessor('referrenceNo', {
        ...
        size: 200,
        Cell: ({ row }) => {
            const transactionReferenceValue = row.original.referrenceNo;
            return (

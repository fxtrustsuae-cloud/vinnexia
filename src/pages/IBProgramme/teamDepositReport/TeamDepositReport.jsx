...
import { TeamDepositReportHeaderColumn } from './TeamDepositReportHeaderColumn';
...
function TeamDepositReport() {
  ...
  const columns = useMemo(() => TeamDepositReportHeaderColumn, []);
  ...
  return (
    <Container>
      <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Team Deposit Report</Typography>
      <Box sx={{
        display: 'flex',

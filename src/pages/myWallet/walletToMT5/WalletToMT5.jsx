...
function WalletToMT5() {

    return (
        <Stack mb={"10rem"}>
            <Container>
                <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Wallet To MT5</Typography>
                <Card
                    sx={{
                    ...
                    <Grid container size={12} spacing={3}>
                        ...
                        <Grid item size={{ xs: 12, sm: 6, md: 4 }}>
                            ...
                            <TextField
                                ...
                                variant="outlined"
                                helperText="Your wallet balance: 0 USD"
                            />
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 6, md: 4 }}>

...
import { data } from "./withdrawReportData";
...
const columns = [
  ...
  columnHelper.accessor('withdrawTo', {
    header: 'Withdraw To',
    size: 150,
  }),
...
function WithdrawReport() {
  ...
  return (
    <Container>
      <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Withdraw Report</Typography>

...
import { data } from "./internalTransferReport";
...
function InternalTransferReport() {
  ...
  return (
    <Container>
      <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"} mb={"2rem"}>Internal Transfer Report</Typography>

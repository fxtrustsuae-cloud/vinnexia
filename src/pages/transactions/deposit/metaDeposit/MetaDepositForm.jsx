...
import { metaDepositSchema } from './metaDepositSchema';
import { useGetUserDataQuery, useMetaDepositMutation } from '../../../../globalState/userState/userStateApis';
import { setNotification } from '../../../../globalState/notificationState/notificationStateSlice';


function MetaDepositForm() {
    ...
    const {
        ...
        resolver: zodResolver(metaDepositSchema),
        defaultValues
    });

    const [metaDeposit, { isLoading }] = useMetaDepositMutation()

    const onSubmit = async (data) => {

        try {
            const response = await metaDeposit(data).unwrap();
            if (response?.status) {
...
export default MetaDepositForm;
...
import { useMetaDepositMutation } from '../../../../globalState/userState/userStateApis';
import { z } from 'zod';
...
function MetaDeposit({ data, onClose }) {
    ...
    return (
        ...
        >
            <Typography variant='h5' fontWeight={"700"} fontSize={"1.8rem"}>Meta Deposit</Typography>
            <Box>
